      ...
      <div className="w-full max-w-[1600px] 2xl:max-w-[1780px] mx-auto px-4 sm:px-6 md:px-10 lg:px-12 2xl:px-16 py-3.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            onClick={closeMobile}
          >
            <div className="relative flex items-center justify-center w-8 h-8 rounded-xl liquid-glass-btn transition-colors duration-200 overflow-hidden p-0.5">
              <img src="/profile.jpg" alt="Pugazhenthi S" className="w-full h-full object-cover object-top rounded-lg group-hover:scale-110 transition-transform duration-200" />
            </div>
            <span>
