...
export default function Projects() {
  ...
  return (
    <section id="projects" className="border-t border-theme-border pt-10 sm:pt-14 theme-transition">
      ...
      {filtered.length === 0 && (
        <div className="text-center py-12 text-theme-muted font-mono text-sm">
      ...
      <div className="mt-8 p-5 sm:p-7 rounded-2xl glass-card bg-theme-surface border border-theme-border/80 flex flex-col sm:flex-row items-center justify-between gap-4 relative overflow-hidden group">
        ...
        <div className="flex items-center gap-4 relative z-10 text-center sm:text-left">
          ...
          <div>
            <h4 className="font-display font-bold text-lg sm:text-xl text-theme-text">Want to see more repositories &amp; open source code?</h4>
            <p className="text-xs sm:text-sm text-theme-muted font-body mt-0.5">Explore algorithm implementations, full stack microservices, and AI experiments on GitHub.</p>
          </div>
        </div>
        <a
